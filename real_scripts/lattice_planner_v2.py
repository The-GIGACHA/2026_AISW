...
class Parameter:
    ...
    INPUT_JSON = os.environ.get('HL_MAP_JSON') or os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'map', 'kcity_map.json') # json파일 경로 (HL_MAP_JSON 환경변수로 변경 가능)
    ...
    # 횡단보도 구간 
    CROSSLINE_IDX_START_0 = 475
    #CROSSLINE_IDX_END_0 = 
    CROSSLINE_IDX_START_1 = 550
    CROSSLINE_IDX_END_1 = 565
    CROSSLINE_IDX_START_2 = 820
    CROSSLINE_IDX_END_2 = 832
    CROSSLINE_IDX_START_3 = 895
    CROSSLINE_IDX_END_3 = 903
